  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,#e0f2fe_0%,#f8fafc_45%,#ffffff_100%)] text-slate-900">
      ...
      <main className="mx-auto grid w-full max-w-7xl gap-6 px-4 py-6 md:grid-cols-[0.8fr_1.2fr] md:px-6 md:py-10">
        ...
        <Card className="border border-slate-200 bg-white/90 text-slate-900 shadow-[0_12px_30px_-24px_rgba(15,23,42,0.7)]">
          <div className="mb-4 rounded-2xl border border-cyan-100 bg-gradient-to-r from-cyan-50 via-white to-indigo-50 p-4">
            ...
            <div className="mt-2 flex items-center gap-2">
              <Bike size={20} className="text-[#d97745]" />
          ...
          {activeOrders.length === 0 ? (
            <p className="text-sm text-slate-600">No active courier tasks right now.</p>
          ) : (
            <div className="space-y-3">
              {activeOrders.map((order) => (
                ...
                >
                  ...
                  <div className="mb-3 grid gap-2 rounded-xl border border-slate-200 bg-white p-3">
                    ...
                    <p className="text-xs text-slate-600">Address: {order.storeAddress}</p>
                    <p className="text-xs text-slate-600">
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-600">Customer: {order.customerName}</p>
                    <p className="text-xs text-slate-600">Dropoff: {order.customerAddress}</p>
                    <p className="text-xs text-slate-600">
