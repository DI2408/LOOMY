...
export default function ShoppingPage() {
  ...
  const { stores, orders, addToCart, loginAsCustomer, customerProfile } = useLumi();
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      addToCart({
                        ...
                        size: selectedSize,
                        qty: 1,
                        unitPriceKr: selected.product.price,
                        imageUrl: selected.product.imageUrl,
                      });
                      setAddingToCart(false);
                      setModalHint("Lagt i kurven — åbn kurven øverst til højre.");
                      window.setTimeout(() => {
                        setSelected(null);
                        setSelectedSize(null);
                        setModalHint("");
